...
vi.mock("./chat-session.js", () => ({ touchChatSession: f.touch, setChatSessionTitleIfEmpty: f.title, ensureChatSession: vi.fn(), getOrCreateEmptyChatSession: vi.fn(), resolveChatSessionForAgent: f.resolveSession, normalizeSessionTitle: vi.fn(), ProjectMembershipError: class extends Error {}, ChatSessionNotFoundError: class extends Error {}, renameChatSession: vi.fn() }));
