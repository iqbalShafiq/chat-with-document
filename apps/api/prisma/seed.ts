...
const MODELS = [
  {
    ...
    description: "GPT-6 Luna — fast, cost-efficient OpenAI chat model for high-volume workloads (verified via OpenRouter 2026-09-24).",
    contextWindowTokens: 1_100_000,
    maxInputTokens: undefined,
    maxOutputTokens: 128_000,
    inputPricePerMTokens: "0.10",
    cachedInputPricePerMTokens: "0.01",
    outputPricePerMTokens: "0.50",
    sortOrder: 0,
  ...
  },
  {
    ...
    name: "GPT 5 Nano",
    label: "Nano",
    hint: "Vision • Lowest cost",
    description:
      "GPT-5 Nano — cheap multimodal chat model with image input (verified via OpenRouter 2026-08-09).",
    contextWindowTokens: 400_000,
    maxInputTokens: 350_000,
    maxOutputTokens: 128_000,
    inputPricePerMTokens: "0.05",
    cachedInputPricePerMTokens: "0.005",
    outputPricePerMTokens: "0.40",
    sortOrder: 2,
    iconSvg: OPENAI_ICON_SVG,
    outputType: "text",
    inputModalities: ["text", "image", "file"],
  ...
  },
  {
    ...
    description:
      "Google Gemini 2.5 Flash Lite — multimodal (image/audio/video input), 1M context (verified via OpenRouter 2026-08-09).",
