  ...
  if (floating) {
    return createPortal(
      <div
        ...
        role="menu"
        aria-label={label}
        className="fixed z-50 min-w-[12.5rem] overflow-hidden rounded-xl border border-white/[0.08] bg-canvas-elevated py-0 text-text shadow-[0_12px_40px_-12px_rgba(0,0,0,0.75)] animate-scale-in"
